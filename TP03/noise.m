...
%
%     For 'ag' noisetype use:  y = NOISE(x,'ag', std_dev, [incidence])
%       where 'std_dev' is the standard deviation of the gaussian noise added and the optional parameter
%       'incidence' is the percentual of pixels affected be the noise (default for additive noise=1).
...
%
%     The 'maximum' and 'std_dev' parameters can be set as percentual of the maximum - minimum image 
